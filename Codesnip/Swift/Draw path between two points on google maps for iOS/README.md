...
class ViewController: UIViewController {
	...
	override func viewDidLoad() {
		...
		let strHome = SRKUtility.addURLEncoding("Sunny Side apartment, Hadosiddapura, Sarjapur road, Bangalore")
		let strOffice = SRKUtility.addURLEncoding("Embassy TechVillage, Bellandur, Bangalore")
